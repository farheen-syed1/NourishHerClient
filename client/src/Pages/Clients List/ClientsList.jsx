    ...
    return (
        ...
        <div className='clients-list__wrapper'>
            <div className='clients-list__header'>
                <h2 className='clients-list__title'>List of our distinguished clients</h2>
            </div>
            <div className='clients-list__slider'>
                <Slider {...settings}>
                    <div className='clients-list__item'>
                        <h6 className='clients-list__name'>Mr Prabhakar Sharan1</h6>
                        <p className='clients-list__role'>Actor/Director</p>
                    </div>
                    <div className='clients-list__item'>
                        <h6 className='clients-list__name'>Mr Prabhakar Sharan1</h6>
                        <p className='clients-list__role'>Actor/Director</p>
